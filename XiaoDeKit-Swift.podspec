...
Pod::Spec.new do |spec|
  ...
  spec.description  = <<-DESC
                      Some Swift Package Collection Which was written by TangXiaoDe in Swift
                      DESC

  spec.homepage     = "https://github.com/TangXiaoDe/XiaoDeKit-Swift"
  ...
  spec.author             = { "TangXiaoDe" => "xiaodehappy@foxmail.com" }
  # Or just: spec.author    = "TangXiaoDe"
  # spec.authors            = { "TangXiaoDe" => "xiaodehappy@foxmail.com" }
  # spec.social_media_url   = "https://twitter.com/TangXiaoDe"
